package io.github.emanuelscapim.libraryapi.controller.common;

import io.github.emanuelscapim.libraryapi.controller.dto.ErroCampo;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RegistroDublicadoException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ErroResposta handleRegistroDublicadoException(RegistroDublicadoException e){
